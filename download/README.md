...
- `assets/kazer-login-symbol.png`: símbolo transparente usado no lançamento do PWA.
- `icons/kazer-192.png` e `icons/kazer-512.png`: ícones legados/apoio visual do app, preservados separadamente do lançamento.
